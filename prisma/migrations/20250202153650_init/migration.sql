...
CREATE TABLE "AllSubject" (
    ...
    CONSTRAINT "AllSubject_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "AllSubject_name_key" ON "AllSubject"("name");
...
-- AddForeignKey
ALTER TABLE "Result" ADD CONSTRAINT "Result_subjectId_fkey" FOREIGN KEY ("subjectId") REFERENCES "AllSubject"("id") ON DELETE CASCADE ON UPDATE CASCADE;
