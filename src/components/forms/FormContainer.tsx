  ...
  if (type !== "delete") {
    switch (table) {
      case "announcement":
        ...
        break;
      case "admission":
        const admissionStudents = await prisma.student.findMany({
          select: { id: true, name: true, surname: true },
        });
        relatedData = { students: admissionStudents };
        break;
      case "users":
      ...
      case "class":
        ...
        break;
      case "classMaterial":
        const classMeterialClasses = await prisma.class.findMany({
          select: { id: true, name: true },
        });
        relatedData = { classes: classMeterialClasses };
        break;
      case "teacher":
